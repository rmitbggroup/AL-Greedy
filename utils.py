...
def load_data(dataset="cora"):
    ...
    ind.[:dataset].test.index => indices of test instances in graph
    """
    ...
    return adj, features, labels, idx_val, idx_test


def get_cora_training_set(idx_val, idx_test):
    training_set = []
    cora_num_node = 2708  # total number of nodes for Cora dataset
    for i in range(cora_num_node):
